...
ouf layout work in progress based on ouf_classic
...
local _TEXTURE = [[Interface\AddOns\oUF_Classic\media\statusbar]]

local font = [[Interface\Addons\oUF_Classic\media\font]]
